...
import type { CategoryWiseExpenseReportDTO } from "@/modules/finance/application/dto/finance-reports.dto";

interface CategoryWiseExpenseReportViewProps {
  report: CategoryWiseExpenseReportDTO;
  fileName: string;
}

// The symmetric counterpart of CategoryWiseIncomeReportView.
export function CategoryWiseExpenseReportView({ report, fileName }: CategoryWiseExpenseReportViewProps) {
