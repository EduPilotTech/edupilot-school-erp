...
// Duplicated from app/students/_components/pagination-links.tsx rather than imported
// cross-route, matching each route's private `_components` colocation convention.
