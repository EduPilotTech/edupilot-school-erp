...
import { BonafideCertificateForm } from "@/components/features/students/BonafideCertificateForm";

interface CertificatePageProps {
  params: Promise<{ studentId: string }>;
}

export default async function BonafideCertificatePage({ params }: CertificatePageProps) {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-10 print:py-0">
      <div className="print:hidden">
        ...
        <h1 className="mt-2 text-2xl font-semibold text-zinc-900">Bonafide Certificate</h1>
